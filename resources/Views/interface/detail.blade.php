    ...
    <main class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="bg-gray-800/50 p-8 rounded-2xl border border-gray-700/50">
                ...
                <form action="{{ url('users/update/' . $user['uid']) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="relative group">
                        ...
                        <div id="imagePreview" class="mt-4 hidden flex flex-col gap-2">
                            <img id="previewImage" class="w-full max-h-48 object-contain rounded-lg border border-cyan-400/50 bg-gray-700/50" src="#" alt="Image Preview">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        <div>
                            ...
                            <form action="/users/delete/{{ $user['uid']}}" method="POST">
                                @csrf
                                <button type="submit" class="flex gap-2 py-3.5 px-6 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-semibold rounded-lg transition-all transform hover:scale-[1.02] shadow-lg shadow-orange-500/20 hover:shadow-orange-500/30">
