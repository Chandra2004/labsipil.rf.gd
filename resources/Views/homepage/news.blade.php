    ...
    <main class="flex-1">
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32">
            <div class="text-center mb-12">
                ...
                <p class="mt-4 max-w-2xl mx-auto text-base sm:text-lg text-gray-600 leading-relaxed">Ikuti terus informasi dan pembaruan terkini seputar kegiatan praktikum.</p>
            </div>

            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                @foreach ($news as $item)
                <article class="flex flex-col overflow-hidden bg-white border border-gray-200/50 rounded-xl shadow-soft transition-transform hover:scale-[1.02] hover:shadow-lg">
                    <div class="p-6">
                    ...
                    <div class="px-6 pb-6">
                        <a href="/news/{{ $item['category'] }}/{{ $item['id'] }}/{{ $item['slug'] }}" class="text-primary hover:underline flex items-center text-sm font-medium transition-colors" aria-label="Baca selengkapnya tentang {{ $item['title'] }}">
                            Baca Selengkapnya
            ...
            <div class="mt-12 flex justify-center">
                <div class="flex flex-col items-center">
                    ...
                    <div class="inline-flex mt-2 xs:mt-0">
                        <a href="{{ url('/news/page/' . ($currentPage - 1)) }}" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-gray-500 bg-gray-100 rounded-s hover:bg-gray-300">
                        ...
                        <a href="{{ url('/news/page/' . ($currentPage + 1)) }}" class="flex items-center justify-center px-3 h-8 text-sm font-medium text-gray-500 bg-gray-100 rounded-e hover:bg-gray-300">
                            Next
