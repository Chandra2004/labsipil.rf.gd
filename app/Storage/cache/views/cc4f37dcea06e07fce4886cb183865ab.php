        ...
        <div class="w-full flex justify-end px-4 sm:px-6">
          ...
          <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-auto">
            ...
            <ul class="p-2 text-sm text-gray-700" aria-labelledby="avatarButton">
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-background rounded-md">Dashboard</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-background rounded-md">Settings</a>
              </li>
              <li>
                <a href="#" class="block px-4 py-2 hover:bg-background rounded-md">Earnings</a>
              </li>
            </ul>
            <div class="p-2">
...
<?php /**PATH C:\laragon\www\resources\Views/dashboard/layouts/layout.blade.php ENDPATH**/ ?>