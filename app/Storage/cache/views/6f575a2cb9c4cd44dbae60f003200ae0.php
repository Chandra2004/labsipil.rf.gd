...
<?php $__env->startSection('content'); ?>
    <main class="flex-1">
        <section class="hero-section relative py-16 sm:py-24 md:py-32 flex items-center">
            <div class="slideshow-container">
                <div class="slideshow-image active"
                    style="background-image: url('https://images.unsplash.com/photo-1463906033650-3288c7071a7b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
                </div>
                <div class="slideshow-image"
                    style="background-image: url('https://images.unsplash.com/photo-1485083269755-a7b559a4fe5e?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
                </div>
                <div class="slideshow-image"
                    style="background-image: url('https://images.unsplash.com/photo-1625722662233-297060231b85?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
                </div>
            </div>
        ...
        <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 md:py-32">
            ...
            <!-- Link untuk melihat semua berita -->
