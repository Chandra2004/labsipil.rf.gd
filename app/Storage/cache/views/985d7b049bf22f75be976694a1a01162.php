        ...
        <div class="p-6">
            ...
            <form class="grid gap-4" action="/register/auth" method="POST">
                ...
                <div class="grid gap-2">
                    ...
                    <input name="npm" id="npm" type="text" placeholder="06.2024.1.07780" required
                ...
                <div class="grid gap-2">
                    ...
                    <input name="full-name" id="full-name" type="text" placeholder="Ahmad Pratama" required
                        class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#468B97]" />
                </div>
                <div class="grid gap-2">
                    <label for="phone" class="text-sm font-medium">Nomor Telepon</label>
                    <input name="phone" id="phone" type="text" placeholder="081234567890" required
                        class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#468B97]" />
                </div>
                <div class="grid gap-2">
                    <label for="email" class="text-sm font-medium">Email</label>
                    <input name="email" id="email" type="email" placeholder="ahmad.pratama@universitas.ac.id" required
                        class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#468B97]" />
                </div>
                <div class="grid gap-2">
                ...
                <div class="grid gap-2">
                    ...
                    <input name="password-confirm" id="password-confirm" type="password" placeholder="••••••••" required
                        class="border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#468B97]" />
                </div>
...
<?php /**PATH C:\laragon\www\resources\Views/auth/register.blade.php ENDPATH**/ ?>